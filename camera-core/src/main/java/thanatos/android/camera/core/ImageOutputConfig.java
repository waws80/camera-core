...
public interface ImageOutputConfig {
     ...
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    Config.Option<Rational> OPTION_TARGET_ASPECT_RATIO =
            Config.Option.create("camerax.core.imageOutput.targetAspectRatio", Rational.class);
    /**
     ...
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    Config.Option<Integer> OPTION_TARGET_ROTATION =
            Config.Option.create("camerax.core.imageOutput.targetRotation", int.class);
    /**
     ...
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    Config.Option<Size> OPTION_TARGET_RESOLUTION =
            Config.Option.create("camerax.core.imageOutput.targetResolution", Size.class);
    /**
     ...
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    Config.Option<Size> OPTION_MAX_RESOLUTION =
            Config.Option.create("camerax.core.imageOutput.maxResolution", Size.class);
