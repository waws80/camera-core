...
import thanatos.android.camera.core.CameraX.ErrorListener;
...
public final class ErrorHandler {
     ...
     */
    void postError(final CameraX.ErrorCode error, final String message) {
    ...
    static final class PrintingErrorListener implements ErrorListener {
        @Override
        public void onError(@NonNull CameraX.ErrorCode error, @NonNull String message) {
